...
export function Singup(props) {
  ...
  const validateForm = values => {
    ...
    if (isCharity && (!regNo || regNo?.trim() === '')) {
      errors.regNo = 'Required!';
    }
    if (isCharity && position === 'select') {
                  ...
                  <Form.Row>
                    <Col>
                      <FormControlLabel
                        control={
                          <CustomCheckbox
                            onChange={e =>
                              setFieldValue('isCharity', e.target.checked)
                            }
                            checked={values.isCharity}
                          />
                        }
                    ...
                    <Col>
                      <div className="loginBtn">
                        <Link className="forgetPassLabel" to="/login">
                          Login
                        </Link>
                      </div>
                    </Col>{' '}
                ...
                {values.isCharity && (
                  <div>
                    ...
                    <Form.Group controlId="position" bssize="large">
                      ...
                      <ErrorMessage name="position" render={FormErrorMessage} />
                    </Form.Group>
                  </div>
                )}
                <Button
                  disabled={!termsConditon || loading}
                  block
                  bssize="large"
                  type="submit"
                  className="submitBtn"
                >
                  {!loading && <div>Signup</div>}
