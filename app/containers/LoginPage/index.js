            ...
            <Form.Group controlid="email" bssize="large">
              <div style={{ position: 'relative' }}>
                <div className="formsDiv" >
                  ...
                  <svg id="Capa_1" className="icons" style={{ color: '#818386' }} enable-background="new 0 0 512.627 512.627" height="20" viewBox="0 0 512.627 512.627" width="20" xmlns="http://www.w3.org/2000/svg"><g>
