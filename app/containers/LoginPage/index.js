...
import { Button, Image, Form, FormControl, Col, InputGroup } from 'react-bootstrap';
        ...
        <Wrapper>
          ...
          <div className="main-container">
            <div className="inner-box">
              <div className="row">
                <div className="col-md-6 col-sm-12 pr-0 fistCol">
                  <div className="pag1" >
                    <div className="logo">
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlid="email" bssize="large">
                          <div style={{ position: 'relative' }}>
                            <div style={{ width: 20, height: 20, position: 'absolute', left: 10, top: 5 }}>
                              <svg id="Capa_1" enable-background="new 0 0 512.627 512.627" height="20" viewBox="0 0 512.627 512.627" width="20" xmlns="http://www.w3.org/2000/svg"><g><path d="M485.743,85.333H26.257C11.815,85.333,0,97.148,0,111.589V400.41c0,14.44,11.815,26.257,26.257,26.257h459.487
			...
			c-3.42-4.227-9.623-4.877-13.844-1.457C363.729,258.329,363.079,264.534,366.5,268.761z"/></g></svg>
                        ...
                        <Button block bssize="large" disabled={!validateForm()} type="submit" className="submitBtn">Login</Button>
                      </form>
