...
const IndividualBankDetailForm = ({ accountNo = 'Bank Name' }) => {
    ...
    <Card className="dataCard shadow mb-5 bg-white">
      <Card.Header className="bankDetailsHeader">
        ...
        {loading ? (
          ...
          <Button onClick={updateBank}>Update Account</Button>
        ) : (
      ...
      {networkError ? (
        <EmptyComponent
          height={363}
          message="Service not availble! Please try again."
        />
      ) : loading ? (
        <LoadingComponent />
      ) : (
            ...
            <div>
              {showAlert ? (
                <Alert severity="error" style={{ marginTop: '5px' }}>
                  ...
                  <strong onClick={updateBank} className="updateLink">
                    {' '}
                ...
                <Row className="justify-content-center">
                  <Col xs={12} sm={6}>
                    <div className={banksAccounts?.id ? '' : 'bankDetailsAdd'}>
                      <div
                        className={
                          banksAccounts?.id ? 'updateBtnBankDetails' : ''
                        }
                      />
                      <Formik
                        initialValues={{
                          ...
                          sortCode:
                            banksAccounts?.bankDetails?.accountLast4Digits ||
                            '',
                              ...
                              <div>
                                ...
                                <FormGroup style={{ flexGrow: '1' }}>
                                  <MaskedInput
                                    ...
                                    value={
                                      conformToMask(values.sortCode, mask)
                                        ?.conformedValue
                                    }
                                    onChange={e => {
                                      setFieldValue(
