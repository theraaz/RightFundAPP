        ...
        <Card.Body>
          <Container>
            {campaign && totalCount > 0 ? <>
              <Row>
                {campaign.map(data => (
                  <Col key={data.id} xs={12} sm={12} md={12} lg={6} xl={4}>
                    <Card className="campaign-card">
                      ...
                      >
                        ...
                        <MenuItem onClick={() => goToEditCampaign(currentCampaignData)} >
                          <div>
                        ...
                        <MenuItem
                          ...
                          <span style={{ marginLeft: '10px' }}>Delete Campaign</span>
                        </MenuItem>
                      ...
                      <Modal className='popup-modal' show={show} onHide={handleClose} >
                        ...
                        <Modal.Body>
                          Are you sure you want to delete your campaign? If you
                          delete you will permanently lose your campaign.
                      </Modal.Body>
                        <Modal.Footer>
                      ...
                      <Card.Body>
                        ...
                        <h3 className="give-card__title" style={{ cursor: 'pointer' }} onClick={() => goToCampaignUpdates(data.id)} >{data.title}</h3>
                        ...
                        <div className="campaignBtns">
                          ...
                          <Button className="editCampaignBtn" onClick={() => openLiveView(data)}>
                            Live View
                            </Button>{' '}
            ...
            </> : <h3>There is no campign, Please create a campaign.</h3>
            }
          </Container>
        </Card.Body>
